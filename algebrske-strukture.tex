...
\begin{document}	
	...
	% 11. 05. 2021
	% todo: beginning redacted
	\begin{theorem}[Lagrangev]
	...
	\begin{proof}
		...
		\[ \langle a \rangle = \lbrace e, a, \ldots, a^{n-1} \rbrace \leq G \overset{\text{lagrange}}{\implies} n = |\langle a \rangle| \text{ deli } |G| \]
	\end{proof}
	...
	\end{conseq}
	\begin{proof}
		\[ |\langle a \rangle| \text{ deli } p \qquad |\langle a \rangle| \geq 2 \]
	...
	\begin{definition}[Podgrupa edinka]
	...
	\begin{definition}[Konjugirana grupa]
	...
	\begin{definition}[Enostavna grupa]
	...
	\begin{proof}
		...
		\[ (a'H)*(b'H) \overset{def}{=} (a'b')H = ak'bk''H = ak'b(k''H) \]
		\[ ak'(bH) \overset{edinka}{=} ak'(Hb) = a(k'H)b \overset{k' \in H}{=} aHb \]
		\[ a(Hb) \overset{edinka}{=} a(bH) \overset{def.}{=} (aH)*(bH) \]
	\end{proof}

	\begin{definition}[Faktorska grupa grupe $G$ po edinki $H$]
	...
	\begin{definition}[Center kolobarja]
